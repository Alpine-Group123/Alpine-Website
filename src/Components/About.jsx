      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start my-4 gap-4">
        <div className="col-md-4 text-start">
          <p className="text fs-6 ">
            ...
            *What We Offer* Mountaineering is more than just a sport—it’s an
            adventure that requires skill, endurance, and deep respect for
            nature. Our platform is dedicated to offering *detailed,
            well-researched information* covering every aspect of
            mountaineering, including:
          </p>
          <Button
            variant="primary"
            className="d-flex align-items-center px-4 py-2 mt-3"
          >
            History
          </Button>
        </div>
        <div className="col-md-4 text-start">
          <p>
            Lorem ipsum dolor sit amet consectetur tsed elitectur adipiscing
            elit sed doLorem ipsum dolor sit amet consectetur adipiscing el
            adipiscing sascing elit sed do esec adipiscing elit sede do.
          </p>
        </div>
